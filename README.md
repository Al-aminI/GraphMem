...
│   │  │                             │  │   │  │                             │  │ │
│   │  │  • id, name, type           │  │   │  │  Key: emb:{text_hash}       │  │ │
│   │  │  • embedding[1536]          │  │   │  │  TTL: 24 hours              │  │ │
│   │  │  • user_id ← ISOLATION      │  │   │  │  Shared across users        │  │ │
│   │  │  • memory_id                │  │   │  │  (same text = same emb)     │  │ │
...
│   │  │    RELATIONSHIP EDGES       │  │   │                                   │ │
│   │  │                             │  │   │  ┌─────────────────────────────┐  │ │
│   │  │  • source_id → target_id    │  │   │  │     QUERY CACHE             │  │ │
│   │  │  • relation_type            │  │   │  │     (Multi-Tenant!)         │  │ │
│   │  │  • ════════════════════     │  │   │  │                             │  │ │
│   │  │  • valid_from  ← TEMPORAL   │  │   │  │  Key: query:{user}:{mem}:   │  │ │
│   │  │  • valid_until ← VALIDITY   │  │   │  │       {query_hash}          │  │ │
│   │  │  • ════════════════════     │  │   │  │  TTL: 5 minutes             │  │ │
│   │  │  • user_id ← ISOLATION      │  │   │  │                             │  │ │
│   │  │  • weight, confidence       │  │   │  │  Alice: query:alice:chat:*  │  │ │
│   │  └─────────────────────────────┘  │   │  │  Bob:   query:bob:chat:*    │  │ │
│   │                                    │   │  │  ═══════════════════════   │  │ │
│   │  ┌─────────────────────────────┐  │   │  │  ISOLATED BY user_id ✅     │  │ │
│   │  │     VECTOR INDEX            │  │   │  └─────────────────────────────┘  │ │
│   │  │                             │  │   │                                   │ │
│   │  │  Type: HNSW (ANN search)    │  │   │  ┌─────────────────────────────┐  │ │
│   │  │  Dimension: 1536            │  │   │  │     SEARCH CACHE            │  │ │
│   │  │  Similarity: cosine         │  │   │  │     (Multi-Tenant!)         │  │ │
│   │  │                             │  │   │  │                             │  │ │
│   │  │  Global index, filtered by: │  │   │  │  Key: search:{user}:{mem}:  │  │ │
│   │  │  WHERE user_id = $user      │  │   │  │       {query_hash}          │  │ │
│   │  │  AND memory_id = $memory    │  │   │  │  TTL: 5 minutes             │  │ │
│   │  └─────────────────────────────┘  │   │  │                             │  │ │
│   │                                    │   │  │  Benefit: Instant repeat   │  │ │
│   └───────────────────────────────────┘   │  │  queries (0ms vs 3.5s)      │  │ │
│                                            │  └─────────────────────────────┘  │ │
│   ┌───────────────────────────────────┐   │                                   │ │
│   │      🧠 IN-MEMORY (Default)       │   │  Auto-Invalidation:               │ │
...
└─────────────────────────────────────────────────────────────────────────────────┘
 ...
 ┌──────────────┐                  ┌──────────────────┐               ┌───────────┐
 │ "Tesla is    │   ──────────▶   │ LLM extracts:    │  ──────────▶  │  Neo4j    │
 │  led by CEO  │                  │                  │               │           │
 │  Elon Musk"  │                  │ Entities:        │               │ (Tesla)───│
 └──────────────┘                  │ • Tesla [Org]    │               │     │     │
        │                          │ • Elon Musk [Per]│               │     ▼     │
        │                          │                  │               │ CEO_OF    │
        │                          │ Relations:       │               │     │     │
...
│
├── stores/
│   ├── neo4j_store.py         # Graph + temporal + vector index
